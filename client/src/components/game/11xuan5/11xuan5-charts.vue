            ...
            <div class="table-main-wrap">
              ...
              <table style="position: sticky;bottom: 0;z-index: 1;">
                ...
                <tfoot class="bg-yellow">
                  <tr>
                    <td>出现次数</td>
                    <td v-for="value in  dwdTableData.analyse.chuxiancishu">
                      {{ value }}
                    </td>
                  </tr>
                  <tr>
                    <td>平均遗漏</td>
                    <td v-for="value in  dwdTableData.analyse.pinjunyilou">
                      {{ value }}
                    </td>
                  </tr>
                  <tr>
                    <td>最大遗漏</td>
                    <td v-for="value in  dwdTableData.analyse.zuidayilou">
                      {{ value }}
                    </td>
                  </tr>
                  <tr>
                    <td>最大连出</td>
                    <td v-for="value in  dwdTableData.analyse.zuidaliangchu">
                      {{ value }}
                    </td>
                  </tr>
                </tfoot>
