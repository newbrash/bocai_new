                  ...
                  <tr v-for="(tr,index) in  basicTableData"
                    ...
                    <td>
                      <div class="flex justify-sa">
                        <span v-for="span in tr.open_code.split(',')">{{span}}</span>
                      </div>
                    </td>
                    <td>{{tr.sum}}</td>
                    <td>{{tr.span}}</td>
            ...
            <div class="table-main-wrap">
              ...
              <table style="position: sticky;bottom: 0;z-index: 1;">
                ...
                <tfoot class="bg-yellow">
                  <tr>
                    <td>出现次数</td>
                    <td v-for="value in  sumTableData.analyse.times">
                      {{ value }}
                    </td>
                  </tr>
                  <tr>
                    <td>平均遗漏</td>
                    <td v-for="value in  sumTableData.analyse.averageMiss">
                      {{ value }}
                    </td>
                  </tr>
                  <tr>
                    <td>最大遗漏</td>
                    <td v-for="value in  sumTableData.analyse.maxMiss">
                      {{ value }}
                    </td>
                  </tr>
                  <tr>
                    <td>最大连出</td>
                    <td v-for="value in  sumTableData.analyse.dalianOut">
                      {{ value }}
                    </td>
                  </tr>
                </tfoot>
...
export default {
  ...
  filters: {
    ...
    keyToCharacter: function(value) {
      ...
      return keyToCharacter[value] || value;
    }
  },
  data() {
    return {
  ...
  methods: {
    ...
    getData(key, size) {
      this.senddata({ data: { type: key, game: "jsks", size } });
    },
