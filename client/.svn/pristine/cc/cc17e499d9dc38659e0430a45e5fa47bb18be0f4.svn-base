    ...
    <div class="flex-wrap flex flow-col">
      <div class="open flex bgc-fff">
        ...
        <div v-if="recentInfo.length"
          ...
          <div class="flex flow-col justify-ct align-stretch">
            <p class="flex justify-sb"><span v-for="(n,index) in recentInfoOpenCode"
                    v-if="index<5"
        ...
        <table>
          ...
          <tbody v-if="recentInfo.length">
            <tr v-for="(tr,index) in recentInfo"
              ...
              <td>{{tr.guanyahe}}</td>
              <td>{{tr.daxiao | keyTOCharate}}</td>
              <td>{{tr.danshuang | keyTOCharate}}</td>
            </tr>
          </tbody>
        </table>
      </div>
...
export default {
  ...
  computed: {
    ...
    handy() {
      return [
        "qianer-qianer-qianerdanshi",
        "qiansan-qiansan-qiansandanshi"
      ].includes(this.currentOdds);
    },
