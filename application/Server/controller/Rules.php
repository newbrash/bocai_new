    ...
    */
    public static function getHuitieFilters()
    {
        ...
        return [
            ...
            'huitie_vip_sliver'=>$systemInfo['huitie_vip_sliver'],
    ...
    /**
    * 获取发帖规则
    * `tie_pride_show` tinyint(5) NOT NULL DEFAULT '1' COMMENT '发帖奖励：1、显示；2、关闭',
    * `tie_pride_num` int(11) NOT NULL DEFAULT '3' COMMENT '发帖奖励帖数',
    * `tie_pride_gold` float(11,2) NOT NULL DEFAULT '0.00' COMMENT '奖励金币',
    * `tie_pride_sliver` float(11,2) NOT NULL DEFAULT '0.00' COMMENT '发帖奖励积分',
    * `tie_limit_words` int(11) NOT NULL DEFAULT '150' COMMENT '发帖标题字数',
    * `tie_limit_seconds` int(11) NOT NULL DEFAULT '0' COMMENT '新用户限制：秒',
    * `tie_limit_relieve` tinyint(5) NOT NULL DEFAULT '1' COMMENT '充值解除限制：1表示开启；0表示关闭',
    * `tie_limit_refender_seconds` int(11) NOT NULL DEFAULT '60' COMMENT '防刷间隔：秒',
    */
    public static function getPostRules()
    {
        // $fatieRules = self::getFatieRules();
        // $filters = self::getFilters();
        // return array_merge($filters, $fatieRules);
        // 获取系统设置
        $systemInfo = json_decode(Redis::get('system_info'), true);
        return [
