...
class MyWorkerServer extends Server
{
    ...
    public function __construct($host, $port, $context = [])
    {
        ...
        defined('ROOT') || define('ROOT', __DIR__.DS.'..'.DS.'..'.DS);

        define("EXPIRE_TIME", 10); //红包和转账过期时间
        ...
        try {
            ...
            switch ($data['type']) {
                ...
                case "responseChatRoomRedbag":
                    Deal::responseChatRoomRedbag($data, $this->userCons);
            }
            ...
            dump("onmessage->catch::".$e->getMessage()." in file ".$e->getFile()." on line:".$e->getLine());
        }
    }
