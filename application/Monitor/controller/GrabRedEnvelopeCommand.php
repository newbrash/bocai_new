...
use app\Monitor\controller\GrabRedEnvelope;
 
// use app\http\controller\MyWorkerServer as MyServer;

class GrabRedEnvelopeCommand extends Command
{
    // 设置处理控制器以及相关指令
    protected function configure()
    {
        ...
        $this->setName('grabred-server') //命令
    ...
    protected function execute(Input $input, Output $output)
    {
         ...
         */
        // 输出描述信息
        $OverdueMonitor = new GrabRedEnvelope();
